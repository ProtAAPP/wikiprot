...
- (08/03) Track de ProtAAPP en el congreso [RootedCON](https://rootedcon.com)
    ...
    * Diego Balboa [HIGHWAY TO RHEL (AC/BC). Auditoría, fortificación y remediación perpetua automatizada de sistemas mediante Infrastructure as Code (IaC). Security as Code (SaC)]([https://github.com/ProtAAPP/wikiprot/blob](https://raw.githubusercontent.com/ProtAAPP/wikiprot/master/docs/01_introduccion/ponencias/rootedcon24/2024-ProtAAPP-RootedCON-dbr.pdf)
